    ...
    <>
      <div className="main-container">
        ...
        <div className="main-container--div">
          ...
          <p>
            With trivago you can easily find your ideal hotel and compare prices
            from different websites. Simply enter where you want to go and your
        ...
        <div className="main-container--div">
          ...
          <p>
            ...
            trivago. Let trivago help you to find the right price from over 300
            booking sites!
          </p>
        </div>
      </div>
        ...
        <div className="main-container-2--div">
          ...
          <div className="cities">
            <div className="cities-1">
              ...
              <p>trivago България</p>
              <p>trivago Canada</p>
              <p>trivago Colombia</p>
              <p>trivago Ecuador</p>
              <p>trivago Schweiz</p>
              <p>trivago Ελλάδα</p>
              <p>Tirupati</p>
